...
def enviar_notificacion_peticion_jud_a_gestor(
    datos, correo_gestor, lista_archivos_adjuntos=None
):
    """Envia una notificacion por correo al gestor cuando el JUD realiza una peticion."""
    asunto = f"Nueva peticion realizada por un JUD: {datos['folio_interno']}"
